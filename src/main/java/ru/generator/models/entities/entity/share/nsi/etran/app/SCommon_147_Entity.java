...
@Subselect("select * from NSI_ETR.S_COMMON where PARAM_ID=147")
...
public class SCommon_147_Entity extends NsiWithTransIdAbstractEntity implements Serializable {
    //    @Id
//    @Column(name = "PARAMID")
//    private Integer paramid;
    ...
    public SCommon_147_Entity() {
    }

    public SCommon_147_Entity(Integer id) {
        this.id = id;
    }
}
