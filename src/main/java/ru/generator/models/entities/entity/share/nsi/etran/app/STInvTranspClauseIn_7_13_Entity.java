...
@Subselect(value = "SELECT * from NSI_ETR.S_T_INV_TRANSP_CLAUSE where TRANSPCLAUSETYPE_ID in (7, 13)")
...
public class STInvTranspClauseIn_7_13_Entity extends NsiWithTransIdAbstractEntity implements Serializable {
    @Id
