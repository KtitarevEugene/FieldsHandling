...
public class InvContEntity {
    ...
    @Description(value = "Номер контейнера ", position = 100)
    private String contNumber;


    @Basic
    @Column(name = "cont_train_number", nullable = true)
    @Description(value = "Номер поезда", position = 200)
    private Integer contTrainNumber;


    @Basic
    @Column(name = "cont_count_in_train", nullable = true)
    @Description(value = "Контейнеров в поезде", position = 300)
    private Integer contCountInTrain;

    @Basic
    @Column(name = "cont_car_order", nullable = true)
    @Description(value = "Номер вагона для контейнерного поезда ", position = 400)
    ...
    @Description(value = "Тип собственности (ID по НСИ - COMMON, тип 7)", position = 500)
    ...
    @Description(value = "Страна-собственник (код ОКСМ по НСИ - COUNTRY)", position = 600)
...
//    private String contOwnerName;
    ...
    @Description(value = "Тоннажность конт. (т) (TONNAGE по НСИ - CONT_TONNAGE)", position = 900)
    ...
    @Description(value = "Размер крупнотоннажного контейнера (CONT_SIZE_ID по НСИ CONT_SIZE_BIG)", position = 1000)
    ...
    @Description(value = "Тип крупнотоннажного контейнера (CONT_TYPE_ID по НСИ CONT_TYPE_BIG) ", position = 1100)
...
//    @Description(value = "Тип крупнотоннажного контейнера (CONT_TYPE_ID по НСИ CONT_TYPE_BIG) ", position = 800)
//    private Integer contTypeBig;

//    @Basic
//    @Column(name = "cont_width_foot", nullable = true, precision = 0)
//    @Description(value = "Футовость крупнотоннажного контейнера", position = 1000)
//    private Double contWidthFoot;

    @Basic
    @Column(name = "cont_volume", nullable = true)
    @Description(value = "Объем", position = 1200)
    private Integer contVolume;

    @Basic
    @Column(name = "cont_weight_dep", nullable = true, precision = 0)
    @Description(value = "Масса в кг тары", position = 1300)
